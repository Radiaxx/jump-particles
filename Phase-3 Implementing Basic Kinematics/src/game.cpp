...
const sf::Vector2f GRAVITY_ACCELERATION = {0.f, 91.f};

Game::Game()
    : m_window(sf::RenderWindow(sf::VideoMode(INITIAL_WINDOW_SIZE), WINDOW_TITLE)),
      m_particle({INITIAL_WINDOW_SIZE.x / 2.0f, INITIAL_WINDOW_SIZE.y / 2.0f}, {60.f, 0.f}, GRAVITY_ACCELERATION, 20.0f, sf::Color::Green)
{
