...
Particle::Particle(sf::Vector2f position, sf::Vector2f velocity, sf::Vector2f accelleration, float mass, float radius, sf::Color color, const sf::RenderTarget &target)
    : m_position(position),
      m_velocity(velocity),
