...
const sf::Vector2f INITIAL_VELOCITY = {227.5f, 136.5f};
...
ParticleSystem::ParticleSystem(
    ...
    : m_totalParticlesToSpawn(totalParticlesToSpawn),
      m_initialTotalParticlesToSpawn(totalParticlesToSpawn),
      m_gravity(gravity),
...
void ParticleSystem::reset()
{
    ...
    m_totalParticlesToSpawn = m_initialTotalParticlesToSpawn;
    m_spawnTimer = 0.f;
...
void ParticleSystem::spawnParticle()
{
    ...
    sf::Vector2f initialVelocity = {INITIAL_VELOCITY.x, INITIAL_VELOCITY.y * static_cast<float>(std::copysign(1.f, m_gravity.y))};
